                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control @error('description') is-invalid @enderror" value="{{ old('description', $portfolio->description) }}" id="description" name="description" placeholder="Add some details if you like">
                            @error('description')
