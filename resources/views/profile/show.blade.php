@extends('layout.app', [
    'breadcrum' => [route('profile.show', $profile) => 'Profile']
    ])
                ...
                <div class="user-profile layout-spacing">
                    <div class="widget-content widget-content-area">
                        ...
                        <div class="text-center user-info">
                            <img src="{{ $profile->avatar() }}" alt="avatar" width="120">
                                ...
                                <ul class="contacts-block list-unstyled">
                                    ...
                                    @if($profile->address || $profile->country)
                                        <li class="contacts-block__item">
                                            ...
                                            </svg>{{ $profile->address }}, {{ $profile->country }}
                                        </li>
                                    @endif
                                        ...
                                        <ul class="list-inline">
                                            ...
                                            <li class="list-inline-item">
                                                <div class="social-icon">
                                                    <a href="{{ $profile->website }}" target="_blank" title="website" class="bs-tooltip">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                         viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                         stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
