    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-12 text-center">
                <h5 class="main-heading">Privacy Policy - {{ config('app.name') }}</h5>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="privacy-container">
        <div class="privacyContent">
            ...
            <div class="privacy-content-container">
                ...
                <h5>Privacy Policy for {{ config('app.fullName') }}</h5>

                <p>At {{ config('app.name') }}, accessible from {{ url('/') }}, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by {{ config('app.name') }} and how we use it.</p>

                <p>If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us.</p>

                <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in {{ config('app.name') }}. This policy is not applicable to any information collected offline or via channels other than this website. Our Privacy Policy was created with the help of the <a href="https://www.privacypolicyonline.com/privacy-policy-generator/">Free Privacy Policy Generator</a>.</p>
